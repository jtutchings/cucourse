...
$settings->add(new admin_setting_configtext('cucourse_roles_not_to_show_block',
                    get_string('rolenottoshowblock', 'block_cucourse'),
                    get_string('descrolenottoshowblock', 'block_cucourse'), ''));

$settings->add(new admin_setting_confightmleditor('cucourse_no_block_top_text',
                    get_string('labelnoblocktoptext', 'block_cucourse'),
                    get_string('descnoblocktoptext', 'block_cucourse'), ''));
$settings->add(new admin_setting_confightmleditor('cucourse_no_block_footer_text',
                    get_string('labelnoblockfootertext', 'block_cucourse'),
                    get_string('descnoblockfootertext', 'block_cucourse'), ''));
